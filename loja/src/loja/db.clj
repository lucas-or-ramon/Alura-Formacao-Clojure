...
(def pedido1 {:usuario 15,
              :itens {:mochila {:id :mochila, :quantidade 2, :preco 80},
                      :camiseta {:id :camiseta, :quantidade 3, :preco 40},
...
(def pedido5 {:usuario 10,
              :itens {:mochila {:id :mochila, :quantidade 20, :preco 80},
                      :camiseta {:id :camiseta, :quantidade 3, :preco 40},
                      :tenis {:id :tenis, :quantidade 1,}}})

(def pedido6 {:usuario 20,
              :itens {:mochila {:id :mochila, :quantidade 2, :preco 80},
                      :camiseta {:id :camiseta, :quantidade 10, :preco 40},
                      :tenis {:id :tenis, :quantidade 1,}}})
